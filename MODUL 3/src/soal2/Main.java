...
public class Main {
    public static void main(String[] args) {
        ...
        for (Negara negara : negaraList) {
            ...
            String jenisKepemimpinanStr = "";
            if (jenisKepemimpinan.equals("monarki")) {
                jenisKepemimpinanStr = "Raja";
                System.out.println("Negara " + negara.getNama() + " mempunyai " + jenisKepemimpinanStr + " bernama " + namaPemimpin + "\n");
            } else if (jenisKepemimpinan.equals("presiden")) {
                jenisKepemimpinanStr = "Presiden";
            } else {
                jenisKepemimpinanStr = "Perdana Menteri";
            }
            if (!jenisKepemimpinan.equals("monarki")) {
